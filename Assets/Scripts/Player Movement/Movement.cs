...
using UnityEngine;
    ...
    public class Movement : MonoBehaviour, IPlayerController
    {
        ...
        private bool cachedQueryStartColliders;
        ...
        private void Awake()
        {
            ...
            cachedQueryStartColliders = Physics2D.queriesStartInColliders;
        }
        ...
        private void CheckCollisions()
        {
            ...
            if (!grounded && groundHit)
            {
                grounded = true;
                usableCoyote = true;
                bufferedUsableJump = true;
                earlyEndedJump = false;
            ...
            Physics2D.queriesStartInColliders = cachedQueryStartColliders;
        }
        ...
        private bool bufferedUsableJump;
        private bool earlyEndedJump;
        private bool usableCoyote;
        private float timeJumpWasPressed;

        private bool HasBufferedJump => bufferedUsableJump && time < timeJumpWasPressed + stats.JumpBuffer;
        private bool CanUseCoyote => usableCoyote && !grounded && time < frameLeftGrounded + stats.CoyoteTime;

        private void HandleJump()
        {
            if (!earlyEndedJump && !grounded && !frameInput.JumpHeld && rigidbody2D.velocity.y > 0) earlyEndedJump = true;
        ...
        private void HandleGravity()
        {
            ...
            else
            {
                ...
                if (earlyEndedJump && frameVelocity.y > 0) inAirGravity *= stats.JumpEndEarlyGravityModifier;
